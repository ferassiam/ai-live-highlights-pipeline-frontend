        ...
        <div className="flex items-center space-x-2">
          {language === 'json' && !readOnly && (
            <button
              ...
              className="text-xs text-gray-500 dark:text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
            >
              Format
            </button>
          )}
      ...
      <div className="relative" style={{ height }}>
        ...
        {showLineNumbers && value && (
          <div className="absolute left-0 top-0 p-4 pointer-events-none select-none">
            <div className="font-mono text-sm text-gray-400 dark:text-slate-500 leading-relaxed">
              {value.split('\n').map((_, index) => (
