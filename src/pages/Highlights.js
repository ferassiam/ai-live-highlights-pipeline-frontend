                    ...
                    <div className="mt-2">
                      <div className="space-y-3">
                        ...
                        {selectedHighlight.summary && (
                          <div>
                            <span className="text-sm font-medium text-gray-500 block mb-1">Summary:</span>
                            <p className="text-sm text-gray-900">{selectedHighlight.summary}</p>
                          </div>
                        )}
                        ...
                        <div>
                          <span className="text-sm font-medium text-gray-500">Source File:</span>
