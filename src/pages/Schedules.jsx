      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        {schedules.length === 0 ? (
          <div className="col-span-2">
            <EmptyState
              title="No schedules"
              description="Get started by creating a new schedule."
              icon={CalendarIcon}
            >
              <Button
                variant="primary"
        ...
        <Dialog as="div" className="relative z-50" onClose={setIsModalOpen}>
          ...
          <div className="fixed inset-0 z-10 overflow-y-auto">
            <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
              ...
              >
        <Dialog.Panel className="relative w-full transform overflow-hidden rounded-lg bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-left shadow-elevated transition-all sm:my-8 sm:w-full sm:max-w-2xl">
                  <form onSubmit={handleSubmit}>
                    {/* Header */}
          <div className="px-6 py-4 border-b border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800/50 backdrop-blur-sm flex items-start justify-between">
                    ...
                    <div className="px-6 py-5 space-y-6">
                      ...
                      {/* Channel config */}
                      <div>
                        <h4 className="text-sm font-medium text-slate-900 dark:text-slate-100 mb-4">Channel Configuration</h4>
                      ...
                      {/* Pipeline config */}
                      <div>
                        <h4 className="text-sm font-medium text-slate-900 dark:text-slate-100 mb-4">Pipeline Configuration</h4>
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                          ...
                          <div className="flex items-center pt-6">
                            ...
                            />
                            <label className="ml-2 block text-sm text-slate-900 dark:text-slate-100">
                              Auto-start pipeline
                            </label>
                          </div>
                        </div>
                      ...
                      <div>
                        <div className="flex items-center mb-4">
                          <input
                            ...
                            className="form-checkbox"
                          />
                          <label className="ml-2 block text-sm font-medium text-slate-900 dark:text-slate-100">
                                ...
                                {['twitter', 'instagram', 'facebook', 'linkedin'].map(platform => (
                                  <div key={platform} className="flex items-center">
                                    <input
                                      ...
                                      className="form-checkbox"
                                    />
                                    <label className="ml-2 block text-sm text-slate-900 dark:text-slate-100 capitalize">
                                      {platform}
                                    </label>
                                  </div>
                                ))}
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-4">
                          <h4 className="text-sm font-medium text-slate-900 dark:text-slate-100">Schedule Events</h4>
                        ...
                        <div className="space-y-4">
                          {formData.schedule.events.map((event, index) => (
                            <div key={index} className="border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 rounded-lg p-4">
                              <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                <div>
                                  <label className="form-label">
                                    Type
                    ...
                    {/* Footer */}
                    <div className="px-6 py-4 border-t border-slate-200 dark:border-slate-700 bg-slate-50/30 dark:bg-slate-800/30 flex items-center justify-end gap-3">
